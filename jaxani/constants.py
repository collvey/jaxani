...
class Constants(collections.abc.Mapping):
    """Jax-based NeuroChem constants. Objects of this class can be used as 
    arguments to :class:`AEVComputer`, like ``AEVComputer(**consts)``.

    Attributes:
        species: list of string indicating the species of atoms.
    """
